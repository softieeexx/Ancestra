    ...
    <div className="relative min-h-screen flex flex-col" style={{ background: "#0a0803" }}>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center px-4 py-10 md:py-14">
        ...
        <div className="text-center mb-10 md:mb-12">
          ...
          <h1 className="font-cinzel font-black text-white leading-tight" style={{ fontSize: "clamp(1.8rem, 5vw, 3rem)" }}>
            Select a Swap Mode
          </h1>
        ...
        <p className="mt-10 font-rajdhani text-center tracking-wider" style={{ color: "rgba(255,255,255,0.18)", fontSize: "0.7rem", letterSpacing: "0.2em" }}>
